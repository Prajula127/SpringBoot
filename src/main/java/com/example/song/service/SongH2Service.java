...
public class SongH2Service implements SongRepository{
    ...
    public ArrayList<Song> getSongs() {
        List<Song> lists = db.query("select * from playlist", new SongRowMapper());
        ArrayList<Song> song = new ArrayList<>(lists);
        return song;
    }
    ...
    public Song addSong(Song song){
        ...
        return db.queryForObject("select * from playlist where songName=? and musicDirector=?", new SongRowMapper(), song.getSongName(),song.getMusicDirector());
    }
